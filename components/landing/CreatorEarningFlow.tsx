  ...
  return (
    ...
    >
          ...
          return (
            ...
            >
              ...
              {idx < flowSteps.length - 1 && (
                <div className="absolute top-7 left-[60%] right-[-40%] h-px bg-gradient-to-r from-emerald-300 to-emerald-100 z-0" aria-hidden />
              )}

              <div className="relative z-10 w-14 h-14 rounded-2xl bg-emerald-50 border-2 border-emerald-200 flex items-center justify-center mb-4 shadow-sm">
        ...
        {flowSteps.map((step, idx) => {
          ...
          return (
            ...
            >
              ...
              {idx < flowSteps.length - 1 && (
                <span
                  className="absolute left-[27px] top-[60px] bottom-[-20px] w-px bg-emerald-200"
                  aria-hidden
                />
              )}

              <div className="relative z-10 shrink-0 w-14 h-14 rounded-2xl bg-emerald-50 border-2 border-emerald-200 flex items-center justify-center shadow-sm">
                <Icon className="w-6 h-6 text-emerald-700" />
              </div>
      ...
      <div className="mt-14 sm:mt-16 max-w-3xl mx-auto rounded-3xl bg-neutral-900 text-white p-7 sm:p-10 border border-neutral-800 shadow-xl shadow-neutral-900/15">
        ...
        >
          Transparent split. <span className="italic text-emerald-400">No hidden cuts.</span>
        </h3>

        <ul className="space-y-3">
          <li className="flex items-center gap-4 py-3 border-b border-white/10">
            <span className="text-emerald-400 font-bold text-sm w-12 shrink-0">₱300</span>
          ...
          <li className="flex items-center gap-4 py-3 border-b border-white/10">
            <span className="text-emerald-400 font-bold text-sm w-12 shrink-0">₱500</span>
            <span className="flex-1 text-white/85 text-sm sm:text-base">You earn — video interview submission</span>
            <ArrowRight className="w-4 h-4 text-white/40" aria-hidden />
          </li>
          <li className="flex items-center gap-4 py-3 border-b border-white/10">
            <span className="text-emerald-400 font-bold text-sm w-12 shrink-0">₱1,000</span>
