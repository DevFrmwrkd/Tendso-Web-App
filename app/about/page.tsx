...
export const metadata = {
  title: "About — Negosyo Digital",
  description:
    "Negosyo Digital pays Filipinos to digitize local businesses. We use AI to build real coded websites in 48 hours. Local businesses get online for ₱1,000. Creators earn ₱300–₱500 per submission.",
};
...
const businessSteps = [
  ...
  },
  {
    ...
    desc: "A trained Negosyo Digital creator comes to your shop, takes photos, and records a short interview.",
  },
  {
    icon: Globe,
      ...
      <main className="relative z-10 w-full flex flex-col items-center">
        ...
        <section className="w-full py-12 sm:py-16 px-6 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
            <div className="rounded-3xl bg-emerald-50/50 border border-emerald-100 p-7 sm:p-8">
            ...
            <div className="rounded-3xl bg-neutral-900 text-white p-7 sm:p-8 border border-neutral-800">
              <p className="text-xs uppercase tracking-widest font-bold text-emerald-400 mb-3">
                For creators
              </p>
              <h2
                style={{ fontFamily: "var(--font-fraunces)" }}
              ...
              <Link
                href="/creators"
                className="group inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-400 text-neutral-900 px-5 py-3 rounded-full font-semibold text-sm transition-transform hover:scale-[1.02] min-h-[44px]"
              >
                Become a creator
        ...
        <section className="w-full py-16 sm:py-20 px-6 max-w-7xl mx-auto">
          <div className="max-w-2xl mx-auto text-center mb-12">
            ...
            >
              How a business gets a <span className="italic text-emerald-700">website.</span>
            </h2>
        ...
        {/* HOW CREATORS EARN */}
        <section className="w-full py-16 sm:py-20 px-6 bg-emerald-50/50 border-y border-emerald-100">
          <div className="max-w-7xl mx-auto">
            <div className="max-w-2xl mx-auto text-center mb-12">
              ...
              <h2
                ...
                className="text-3xl sm:text-4xl md:text-5xl font-semibold text-neutral-900 leading-[1.1] mb-4"
              >
                How a creator <span className="italic text-emerald-700">earns.</span>
              </h2>
              <p className="text-neutral-700 leading-relaxed">
            ...
            <ol className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
              {creatorSteps.map((step, idx) => {
                ...
                return (
                  <li
                    key={step.title}
                    className="rounded-3xl bg-white border border-neutral-200 hover:border-emerald-300 hover:shadow-lg hover:shadow-emerald-900/5 transition-all p-6 sm:p-7"
                  >
                    <div className="flex items-center justify-between mb-4">
                      <span
                        style={{ fontFamily: "var(--font-fraunces)" }}
                        className="text-3xl font-semibold text-emerald-100"
                      >
                        0{idx + 1}
                      </span>
            ...
            <div className="mt-10 text-center">
              <Link
                href="/creators"
                className="group inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3.5 rounded-full font-semibold text-base transition-transform hover:scale-[1.02] shadow-md shadow-emerald-900/20 min-h-[48px]"
              >
        ...
        <section className="w-full py-16 sm:py-20 px-6 max-w-7xl mx-auto">
          <div className="max-w-2xl mx-auto text-center mb-12">
            ...
            <h2
              ...
              className="text-3xl sm:text-4xl md:text-5xl font-semibold text-neutral-900 leading-[1.1] mb-4"
            >
              A real website. <span className="italic text-emerald-700">Not a template.</span>
            </h2>
          </div>
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 max-w-5xl mx-auto">
            {[
              ...
              >
                <span className="shrink-0 mt-0.5 w-5 h-5 rounded-full bg-emerald-100 flex items-center justify-center" aria-hidden>
                  <svg className="w-3 h-3 text-emerald-700" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={3}>
        ...
        <section className="w-full py-20 sm:py-24 px-6 relative overflow-hidden flex items-center justify-center bg-white">
          ...
          <div className="relative z-10 text-center text-white max-w-3xl mx-auto py-10 sm:py-14 px-2">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3">
              <a
                href={PHONE_TEL}
                className="group flex items-center justify-center gap-3 bg-emerald-500 hover:bg-emerald-400 text-neutral-900 px-7 py-4 rounded-full font-bold text-base sm:text-lg transition-transform hover:scale-[1.02] shadow-xl shadow-emerald-500/30 min-h-[52px]"
              >
