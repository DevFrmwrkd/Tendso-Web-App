...
const STATUS_STYLES: Record<string, { bg: string; text: string; dot: string; label: string }> = {
  ...
  approved: { bg: "bg-amber-50", text: "text-amber-800", dot: "bg-amber-500", label: "Approved" },
  ...
  paid: { bg: "bg-amber-50", text: "text-amber-800", dot: "bg-amber-600", label: "Paid" },
  completed: { bg: "bg-amber-50", text: "text-amber-800", dot: "bg-amber-600", label: "Completed" },
